...
//ek company ki example mai lo -  Stateless widget maanlo boss hai woh khud bolra hai ki tum ek method override karo jisme tum tumahre sab task batao joh aapne aaj ke din kare
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      // ),
      // drawer: Drawer(),
      // Ye daalne se kone mai debug karke bata ta hai woh hatjayega per isko true rehendo kyuki hum abhi testing mai hai
...
//ye per dikhana padega kyuki Myroutes joh naam define kare ho woh dkhna chahiye woh define hona chahiye nhi toh ye error fhekega
        "/": (context) => LoginPage(), //creating object of out class..
        "/homepage": (context) => HomePage(),
        "/Login": (context) => LoginPage(),
// objetc bana nhi padh rha hai dekho () aysa karke nhi bana padh raha hai
